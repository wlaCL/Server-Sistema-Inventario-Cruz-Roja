...
var usuario_route_1 = __importDefault(require("../routes/usuario.route"));
...
var Server = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, connection_db_1.default.authenticate()];
                    case 1:
                        _a.sent();
    ...
    Server.prototype.routes = function () {
        this.app.use(this.apiPath.usuarios, usuario_route_1.default);
