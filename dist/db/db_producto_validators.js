...
exports.ExisteProductoID = exports.ExisteProductoNombre = void 0;
...
var ExisteProductoNombre = function (nombre) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, producto_1.TProducto.findOne({
                        where: {
                            nombre: nombre,
                            estado: true
                        }
...
var ExisteProductoID = function (id) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, producto_1.TProducto.findByPk(id)];
                case 1:
                    producto = _a.sent();
                    if (!producto) {
...
//# sourceMappingURL=db_producto_validators.js.map