...
var getCategorias = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                _d.trys.push([1, 3, , 4]);
                return [4 /*yield*/, producto_1.Categoria.findAndCountAll({
...
var postCategoria = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, producto_1.Categoria.create({
                        nombre: nombre,
...
var putCategoria = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 1:
                _e.trys.push([1, 4, , 5]);
                return [4 /*yield*/, producto_1.Categoria.findOne({
                        where: {
                            id_categoria: id,
                            estado: true
                        }
            ...
            case 2:
                categoria = _e.sent();
                return [4 /*yield*/, producto_1.Categoria.update({
