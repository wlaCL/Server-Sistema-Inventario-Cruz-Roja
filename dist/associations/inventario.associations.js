...
models_1.Producto_Ambulancia.hasOne(models_1.Registro_Producto, { foreignKey: 'id_producambu' });
models_1.Registro_Producto.hasMany(models_1.Producto_Ambulancia, { foreignKey: 'id_producambu' });
